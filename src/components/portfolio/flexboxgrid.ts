...
const containerSm = `${smMin + 1}rem`;
const containerMd = `${mdMin + 1}rem`;
const containerLg = `${lgMin + 1}rem`;

const smViewport = `only screen and (min-width: ${screenSmMin})`;
const mdViewport = `only screen and (min-width: ${screenMdMin})`;
const lgViewport = `only screen and (min-width: ${screenLgMin})`;
