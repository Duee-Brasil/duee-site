...
const NossoTrabalho = () => (
  <Content>
    ...
    <Card>
      <Icon alt="PROMOÇÕES e TRADE" src={Eventos} />
    ...
    <Card>
      <Icon alt="DESENVOLVIMENTO" src={Dev} />
