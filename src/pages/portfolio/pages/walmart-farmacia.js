...
export default class Farmacia extends React.Component {
    ...
    render() {
        return <article className="cases row col-xs-12" style={{ backgroundColor: "white" }}>
            <div className="col-12 title">
                <h2 style={{ color: 'black' }}>FARMÁCIAS WALMART – AÇÕES DE SAMPLING</h2>
            ...
            <div className="row content describes" style={{ color: 'black' }}>
                <div className="col-xs-12 col-md-8 col-sm-6">
                    ...
                    <p>Planejamos uma campanha de ativação com ações específicas para as Farmácias Walmart, em 21 praias de todo o Brasil.</p>
                </div>
