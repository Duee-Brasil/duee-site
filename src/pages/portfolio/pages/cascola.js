...
export default class Cascola extends React.Component {
    ...
    render() {
        return <article className="cases row col-xs-12" style={{ backgroundColor: "white" }}>
            <div className="col-12 title">
                <h2 style={{ color: 'black' }}>CASCOLA – DIGITAL</h2>
            ...
            <div className="row content describes" style={{ color: 'black' }}>
                <div className="col-xs-12 col-md-8 col-sm-6">
                    ...
                    <p>Desenvolvemos projetos digitais, incluindo site, SEO, chat online, wikis, fóruns de discussões, FAQ e concursos culturais para promover a marca e seus produtos.</p>
                </div>
                <div className="col-xs-12 col-md-4 col-sm-6">
                    <p><b>DETALHES DO PROJETO</b></p>
                    <p><b>CLIENTE</b> Cascola</p>
                    <p><b>DATA</b> 2011</p>
                </div>
            </div>
        </article>
