...
/** Substitui react-collapse: anima altura até “auto” via grid */
const ExpandableSection = styled.div<{ $open: boolean }>`
  display: grid;
...
const SomosLeoes = () => {
  ...
  return (
    <Layout title="Somos leões">
      <Content>
        <VideoHeader>
          <img alt="#somosleoes" src={Hashtag} />
        </VideoHeader>
        ...
        <Video>
          <video
            ...
            autoPlay={true}
            muted={true}
            src="https://firebasestorage.googleapis.com/v0/b/duee-site.appspot.com/o/DUEE_FINAL_23.mp4?alt=media&token=baebc8e4-b575-4b8d-92cc-286658cdd056"
          />
        </Video>
        ...
        <GenteFaz>
          <Manifesto>
            <p>
              Com 14 anos de mercado a DUEE Brasil é uma agência full service,
              que surgiu com objetivo de atender marcas globais que querem ser
              relevantes no mercado nacional.
            </p>
            <p>
              Trabalhamos a comunicação de forma integrada, planejando e
              executando ações em diferentes canais (Online e Offline).
            </p>
            <p>
              Não realizamos apenas conteúdos e campanhas, nós geramos ideias e
              conexões. Somos uma agência que acredita no trabalho que está em
              constante movimento, buscando o que há de melhor no mercado da
              comunicação: tendências, inovações e transformação.
            </p>
            <p>
              É por meio de nossa paixão, criatividade e de estratégias que
              ajudamos marcas globais a terem retornos eficientes e se tornarem
              relevantes no mercado local.
            </p>
          ...
          <Resumo>
            ...
            <h1 className="glitchhover" data-value="A GENTE FAZ">
              A GENTE FAZ
            </h1>
          </Resumo>
        </GenteFaz>
        ...
        <Versinho>
          ...
          <VersinhoText>
            ...
            <h3>
              Estamos sempre nos desafiando e caçando oportunidades de fazer
              diferente.
            </h3>
            <h3>Somos leões.</h3>
          </VersinhoText>
        ...
        <NewsCollapse>
          <VermaisButton>
            <button type="button" onClick={() => setOpenNews(!openNews)}>
              {openNews ? 'Fechar' : 'Ver mais'}
            </button>
          </VermaisButton>

          <Vermais>
            <ExpandableSection $open={openNews}>
              ...
              <Depoimentos>
                ...
                <SwipeableViews
                  autoPlay
                  index={pageIndex}
                  onChangeIndex={(e) => setPageIndex(e)}
                >
                  <Depo>
                    <h5>
                      “Os maiores diferenciais da Duee são principalmente a
                      confiança, transparência e qualidade. A Duee é uma agência
                      que preza pelo respeito com o cliente.”
                    </h5>
                    <p>
                      <strong>Sandra Collier</strong>
                    </p>
                    <p>Gerente de Marketing, Walmart Brasil</p>
                  </Depo>
                  <Depo>
                    <h5>
                      “É uma agência com flexibilidade, aberta a mudanças e eles
                      sempre entregam com bastante agilidade.“
                    </h5>
                    <p>
                      <strong>Maricy Gattai</strong>
                    </p>
                    <p>Gerente de Marketing, Bauducco</p>
                  </Depo>
                  <Depo>
                    <h5>
                      “O que é muito legal da Duee, é que ela sempre traz uma
                      proposta 360o. Isso, pra gente, facilita muito.”
                    </h5>
                    <p>
                      <strong>Fernando Colino</strong>
                    </p>
                    <p>Gerente de Compras, Pernod-Ricard Brasil</p>
                  </Depo>
                  <Depo>
                    <h5>
                      “A qualidade gráfica e criativa do projeto foi muito
                      interessante. Temos sempre os retornos muito rápidos com
                      uma flexibilidade e agilidade para resolver qualquer
                      contratempo.”
                    </h5>
                    <p>
                      <strong>Vanessa Campanholo</strong>
                    </p>
                    <p>Gerente de Marketing, AES Eletropaulo</p>
                  </Depo>
                </SwipeableViews>
              </Depoimentos>
              ...
              <Midia>
                ...
                <News
                  img={JovenPan}
                  link="http://jovempan.uol.com.br/opiniao-jovem-pan/consultores/cesar-adames/codorniu-convida-experts-para-criar-bebidas-autorais-com-cava.html"
                  title="CODORNÍU CONVIDA EXPERTS PARA CRIAR BEBIDAS AUTORAIS COM CAVA"
                />
                <News
                  img={Propmark}
                  link="http://propmark.com.br/anunciantes/mascote-da-cerveja-belga-vedett-invade-cidade-de-sao-paulo"
                  title="MASCOTE DA CERVEJA BELGA VEDETT INVADE CIDADE DE SÃO PAULO"
                />
                <News
                  img={Propmark}
                  link="http://propmark.com.br/agencias/duee-brasil-assume-conta-da-codorniu-da-interfood-importacao"
                  title="DUEE BRASIL ASSUME CONTA DA CODORNÍU, DA INTERFOOD IMPORTAÇÃO"
                />
                <News
                  img={Blog}
                  link="http://blogdofernandocoelho.blogspot.com.br/2015/03/voce-ja-ouviu-falar-em-comunicacao-all.html"
                  title="MARKET LOOK COM HENRIQUE CASTRO"
                />
                <News
                  img={Propmark}
                  link="http://propmark.com.br/digital/entre-aspas-engajamento-organico"
                  title="ENTRE ASPAS: ENGAJAMENTO ORGÂNICO"
                />
                <News
                  img={Adonline}
                  link="http://www.adonline.com.br/rapidinhas/57746-duee-brasil-assume-como-uma-das-agencias-de-lg.html"
                  title="DUEE BRASIL ASSUME COMO UMA DAS AGÊNCIAS DE LG"
                />
                <News
                  img={meiomsg}
                  link="http://www.meioemensagem.com.br/home/comunicacao/2015/10/23/dan-a-das-contas-duracell-e-unesco.html"
                  title="DANÇA DAS CONTAS"
                />
                <News
                  img={Propmark}
                  link="https://dueebrasil.com.br/Site_2016?page_id=907"
                  title="ESPANHOLA CODORNÍU LANÇA WEBSÉRIE NO BRASIL"
                />
                <News
                  img={Grandes}
                  link="http://grandesnomesdapropaganda.com.br/tag/duee-brasil/"
                  title="COINTREAU RENOVA POSICIONAMENTO"
                />
                <News
                  img={Promoview}
                  link="http://www.promoview.com.br/agencia/contas/duee-brasil-conquista-duas-novas-contas.html"
                  title="DUEE BRASIL CONQUISTA DUAS NOVAS CONTAS"
                />
                <News
                  img={Mundomkt}
                  link="https://www.mundodomarketing.com.br/artigos/henrique-castro/34101/como-se-comportar-na-rede-social-quando-o-consumidor-precisa-de-voce.html"
                  title="COMO SE COMPORTAR NA REDE SOCIAL QUANDO O CONSUMIDOR PRECISA DE VOCÊ"
                />
                <News
                  img={meiomsg}
                  link="http://www.meioemensagem.com.br/home/comunicacao/2015/11/13/dan-a-das-contas-catho-editora-salvat-e-brilia.html"
                  title="DANÇA DAS CONTAS: CATHO, SALVAT E BRILIA"
                />
                <News
                  img={Mkgpro}
                  link="http://www.propagandasc.com.br/agencia_duee_brasil_assume_novos_clientes.html"
                  title="AGÊNCIA DUEE BRASIL ASSUME NOVOS CLIENTES"
                />
                <News
                  img={Clientesa}
                  link="http://www.clientesa.com.br/marketingderelacionamento/58535/amostra-de-uma-fidelizacao/Ler.aspx"
                  title="AMOSTRA DE UMA FIDELIZAÇÃO"
                />
                <News
                  img={Proxxima}
                  link="http://www.proxxima.com.br/busca-proxxima?search=duee+brasil&ordenar=data&periodode=&periodoate=&categoria=&dias="
                  title="O UBER ALÉM DO UBER E A REVOLUÇÃO DA INDÚSTRIA AUTOMOBILÍSTICA"
                />
              </Midia>
              </div>
            </ExpandableSection>
